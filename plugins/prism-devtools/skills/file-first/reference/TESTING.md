...
python "../../file-first/scripts/analyze_codebase.py" "C:/path/to/repo"

# JSON output for programmatic use
python "../../file-first/scripts/analyze_codebase.py" "C:/path/to/repo" --format json

# Force a specific project type
python "../../file-first/scripts/analyze_codebase.py" "C:/path/to/repo" --type react_frontend
```
...
```bash
# Basic usage
python "../../file-first/scripts/validate_file_first.py" --story "C:/path/to/story.md"

# JSON output
python "../../file-first/scripts/validate_file_first.py" --story "C:/path/to/story.md" --format json
```
