...
def main() -> int:
    ...
    rows = [
        ...
        },
        {
            ...
            "external_best_reference": "Terminal-Bench 2.0 official leaderboard: Codex CLI with GPT-5.5 at 82%, ForgeCode with GPT-5.4 at 81.8%",
        ...
        },
        {
            ...
            "external_best_reference": "BFCL V4 official leaderboard: Claude Opus 4.6 77.47% overall accuracy; official page last updated 2026-04-12",
        ...
        },
        {
            ...
            "domain": "tool_use",
            "metric": "pass_rate",
            "external_best_reference": "Scale MCP Atlas official leaderboard: Muse Spark 82.4% pass rate on the public 500-task subset and 82.2% on all 1,000 MCP tasks; 36 MCP servers and 220 tools",
            "external_best_value": 0.824,
            "prism_value": None,
            "status": _status(None, comparable=False),
            "gap": "PRISM has not been run on MCP Atlas or an equivalent real-MCP-server multi-tool orchestration harness",
            "source_urls": [
                "https://labs.scale.com/leaderboard/mcp_atlas",
                "https://labs.scale.com/papers/mcpatlas",
                "https://static.scale.com/uploads/674f4cc7a74e35bcaae1c29a/MCP_Atlas.pdf",
            ],
            "checked_at": "2026-05-04",
            "next_action": "Add a PRISM-on/off MCP Atlas harness using the public 500-task subset, the same model, the interactive MCP profile, and pass-rate/coverage/tool-use diagnostics.",
        },
        {
