...
3. **Handle user choice:**
   ...
   **If Update (1):**
   ...
   - **Announce:** "✅ Updated: {{existing_path}}"
   ...
   **If Create Separate (2):**
   ...
   - **Announce:** "✅ Created: {{new_path}} (related to {{existing_path}})"

   **If Skip (3):**
   - Mark in index as "See: {{existing_path}}"
   - Don't create duplicate
   - **Announce:** "⏭️ Skipped: Using existing {{existing_path}}"
...
**Announce to user:** "✓ Step 6.5 Complete: Checked existing documentation"
**Display:** "📊 Reuse: {{updated}} updated, {{created}} created, {{skipped}} skipped"
...
- **Announce to user:** "✓ Step 7 Complete: Master index created at {{output_folder}}/index.md"
...
📊 Documents Planned: {{stats.planned}}
✅ Existing Updated: {{stats.updated}}
🆕 New Created: {{stats.created}}
⏭️ Duplicates Avoided: {{stats.skipped}}
📈 Reuse Rate: {{(stats.updated + stats.skipped) / stats.planned * 100}}%
```
...
```
🎉 **Document Project Task Complete!**
...
- 📊 Documents Planned: {{stats.planned}}
- ✅ Existing Updated: {{stats.updated}} (reused existing knowledge)
- 🆕 New Created: {{stats.created}} (net new documentation)
- ⏭️ Duplicates Avoided: {{stats.skipped}} (prevented redundancy)
- 🔄 Consolidations: {{consolidation_count}} (merged similar docs)
...
📖 Start here: {{output_folder}}/index.md
