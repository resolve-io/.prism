...
**Related Documents:**
- **Validation:** [strangler-migration-checklist.md](../checklists/strangler-migration-checklist.md)
- **Orchestration:** [strangler-pattern-migration.yaml](../workflows/strangler-pattern-migration.yaml)
...
**For Validation:**
- Use [strangler-migration-checklist.md](../checklists/strangler-migration-checklist.md) for systematic verification

**For Process:**
- Follow [strangler-pattern-migration.yaml](../workflows/strangler-pattern-migration.yaml) workflow orchestration