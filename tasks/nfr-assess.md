...
required:
  ...
  - story_path: `prism-core/core-config.yaml` for the `devStoryLocation`

optional:
  - architecture_refs: `prism-core/core-config.yaml` for the `architecture.architectureFile`
  - technical_preferences: `prism-core/core-config.yaml` for the `technicalPreferences`
